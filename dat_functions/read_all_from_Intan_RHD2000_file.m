function [camtrig, sync_signal, ball1, ball2, ball3, ball4, optotrig, sample_rate] = read_all_from_Intan_RHD2000_file(file_full_path)
...
%read dat file and returns only red syncing signal
...
%     fprintf(1, 'Parsing data...\n');
    ...
    sync_signal = board_dig_in_data(2,:); 
    camtrig=board_dig_in_data(1,:); 
    ball1=board_dig_in_data(3,:); 
    ball2=board_dig_in_data(4,:); 
    ball3=board_dig_in_data(5,:); 
    ball4=board_dig_in_data(6,:); 
    optotrig=board_dig_in_data(7,:);
end
return
